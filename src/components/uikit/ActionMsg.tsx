...
const ActionMsg: React.FC<{children: React.ReactNode,  type: string }> = ({ type ,children}) => {
  return (
    <div className={`${notifyColor(type)} select-none bg-opacity-10 rounded-md transition-opacity animate-init-pulse container mx-auto  p-sm px-md flex gap-xs items-center`}>
